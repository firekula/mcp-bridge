...
declare namespace Editor {
    ...
    export type Options = {
        i18n: any[],/**Specify i18n phrases for your application*/
...
declare namespace Editor {
    export namespace Ipc {
        ...
        export function option(opts: { excludeSelf: boolean }): void

        export function sendToAll(message: string, ...args: any[]): void

        export function sendToMain(message: string, ...args: any[]): void

        export function sendToMainSync(message: string, ...args: any[]): any

        export function sendToMainWin(message: string, ...args: any[]): void
        ...
        export function sendToWins(message: string, ...args: any[]): void
    }
}
...
declare namespace Editor {
    export namespace Package {
         ...
         */
        export function load(path: string, callback: Function)
         ...
         */
        export function unload(path: string, callback: Function)
         ...
         */
        export function reload(path: string, callback: Function)
...
declare namespace Editor {
    export namespace Panel {
         ...
         */
        export function open(panelID: string, argv?: any)
...
declare namespace Editor {
  ...
  */
        export function load(name: string, defaultProfile?: any); export function load(name: string, type: string, defaultProfile?: any)
...
declare namespace Editor {
    export namespace Scene {
        export function callSceneScript(pkgName: string, message: string, cb?: Function): void;
        export function callSceneScript(pkgName: string, message: string, args?: any, cb?: Function): void;
    }
